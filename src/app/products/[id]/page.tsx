    ...
    <main>
      ...
      <div className="flex flex-col md:flex-row justify-center md:gap-20 mt-20 px-4 md:px-0">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-lg font-semibold bg-[#ffb132] text-white py-2 px-4 rounded-full inline-block">
          ...
          {/* Add to Cart Button */}
          <button className="mt-6 w-full md:w-1/2 flex items-center justify-center gap-2 py-3 bg-[#c58a2c] hover:bg-[#9d6f24] text-white font-semibold rounded-md transition" 
